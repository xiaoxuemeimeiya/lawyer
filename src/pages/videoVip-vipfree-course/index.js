...
class Index extends Component {
    ...
    getData() {
        ...
        return member_reccommend(this.state.page, this.state.type)
            .then(res => {
    ...
    render() {
        ...
        <Navigator
            ...
            {/*<View className='label--freeForVip label--freeForVip--Discount label--freeForVip--active'>会员免费</View>*/}

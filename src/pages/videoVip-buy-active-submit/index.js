...
import { couponList, get_lian,verity_code, is_verify, get_sms, get_vipPrice,get_activevipPrice } from "../../api/videoVip"
  ...
  buyVip = () => {
    ...
    if (this.state.userInfo && this.state.userInfo.my_famous) {
      ...
      verity_code({ phone: this.state.data.phone,code: this.state.data.code }).then(res1 => {console.log(res1)
        ...
        get_lian({ total_fee: this.state.vipPrice ,top_id:share_id,type:'active'}).then(res => {

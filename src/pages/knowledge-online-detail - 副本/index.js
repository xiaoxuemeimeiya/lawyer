...
class Index extends Component {
  ...
  initVideo = () => {
    ...
    this.player.once('ready', () => {
      ...
      // // 开始播放后把这个样式移除
      // document.querySelector('.xgplayer-start').addEventListener('touchstart', function () {
      //   document.querySelector('.try-play').classList.add('hide')
      //   document.querySelector('.xgplayer-start').classList.remove('op0')
      // })
  ...
  showBottom = async (videoId) => {
    ...
    if (+this.state.course.price === 0 || (this.state.course.type === 1 && (this.state.userInfo.isClubVIP || this.state.userInfo.lian))) {
      Taro.navigateTo({
        ...
        >
          ...
          <View className='ll-cells ll-cell--noborder' style={{ overflow: 'auto' }}>
            <View className='ll-cell course-title'>
              <View className='ll-cell__bd'>{this.state.course.name}</View>
            ...
            */}
            <Navigator url='/pages/videoVip-buy'>
        ...
        <View className='ll-cells ll-cell--noborder bottom'>
          <View className='ll-cell bottom__bd'>
            ...
            <View className='ll-cell__hd'>
              ...
              >
                <View className='icon icon-kefu'></View>
